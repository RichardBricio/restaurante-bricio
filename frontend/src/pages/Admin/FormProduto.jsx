...
export default function FormProduto({ produto, onSalvar, onCancelar }) {
  ...
  const categorias = ['Bebidas', 'Pizzas', 'Sobremesas', 'Lanches', 'Porções', 'Saladas'];
      ...
      <div className="bg-white rounded-xl max-w-md w-full p-6 max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="bg-blue-50 p-3 rounded-lg text-sm text-blue-800">
            💡 A imagem do produto será buscada automaticamente por IA baseada no nome e categoria!
          </div>

          <div className="flex gap-3 pt-4">
            <button
              type="submit"
              className="flex-1 bg-gradient-to-r from-orange-500 to-red-500 text-white py-2 rounded-lg hover:from-orange-600 hover:to-red-600 transition-all"
            >
